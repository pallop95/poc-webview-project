...
/**
 * <p>Java class for ktbGetPolicyRes complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ktbGetPolicyRes"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="itemList" type="{urn:EmployeeWS/types}ktbGetPolicyList" maxOccurs="unbounded" minOccurs="0"/&gt;
...
@XmlType(name = "ktbGetPolicyRes", propOrder = {
    "itemList",
    "responseCode",
    "responseDescr"
})
public class KtbGetPolicyRes {

    @XmlElement(nillable = true)
    protected List<KtbGetPolicyList> itemList;
     ...
     * {@link KtbGetPolicyList }
     * 
     * 
     */
    public List<KtbGetPolicyList> getItemList() {
        if (itemList == null) {
            itemList = new ArrayList<KtbGetPolicyList>();
        }
